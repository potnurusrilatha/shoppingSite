    ...
    return (
        <div className={`${styles.category} ${styles.featured} ${styles[name]}`}>
            ...
            <div className={styles.productInfo}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum asperiores, praesentium ut odit reprehenderit aliquid atque nisi obcaecati? Suscipit laborum aperiam at! Enim officiis quam eius, temporibus voluptatum culpa exercitationem.</div>
